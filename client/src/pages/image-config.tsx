              ...
              <header className="bg-black/20 backdrop-blur-md border-b border-white/10 px-4 sm:px-6 py-4">
                <div className="flex flex-col space-y-3 sm:flex-row sm:items-center sm:space-y-0 sm:space-x-3">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <h2 className="text-xl sm:text-2xl font-semibold text-white drop-shadow-lg">Image Configuration</h2>
                      <p className="text-sm sm:text-base text-gray-300">Upload custom images and generate tracking links</p>
                    </div>
                  </div>
                </div>
              </header>
        ...
        <div className="flex h-screen relative z-10">
          ...
          <main className="flex-1 overflow-auto">
            ...
            <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
              ...
              <Card className="bg-black/20 backdrop-blur-md border-white/10 text-white shadow-2xl animate-card animate-slide-in-up">
                <CardHeader>
              ...
              {settings?.hasUploadedImage && (
                <Card className="bg-black/20 backdrop-blur-md border-white/10 text-white shadow-2xl animate-card animate-slide-in-up" style={{ animationDelay: '200ms' }}>
                  <CardHeader>
                    <CardTitle className="flex items-center space-x-2">
              ...
              {/* Image Upload */}
              <Card className="bg-black/20 backdrop-blur-md border-white/10 text-white shadow-2xl animate-card animate-slide-in-up" style={{ animationDelay: '300ms' }}>
                <CardHeader>
                  <CardTitle className="flex items-center space-x-2">
              ...
              {/* Usage Tips */}
              <Card className="bg-black/20 backdrop-blur-md border-white/10 text-white shadow-2xl animate-card animate-slide-in-up" style={{ animationDelay: '400ms' }}>
                <CardHeader>
